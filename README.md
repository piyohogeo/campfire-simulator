...
現在は **Phase 6「校正と品質」進行中** です。公称12.7 mm・5層の合板試験片で、公開されたガス・タール・チャーの3つの一次Arrhenius反応を同時に解きます。各層の乾燥木材消費率から未収縮の質量等価熱分解深さを診断しますが、これは物理的な炭化層厚さではありません。合板の収縮根拠がないため物理厚さとDarcy滞留時間は保留しています。
...
次の作業は合板の厚さ方向収縮と炭化前線について一次資料を確保し、固定格子の質量等価深さから独立した物理炭化層厚さを定義できるか判断することです。厚さ方向空隙率・透過率、高温混合気粘度、圧力差も直接根拠を確保してから追加し、生成物収率、追加熱流束、またはFDSで外部条件を再検証します。
