"""Stream and durably commit a bounded Phase 6FY memory artifact pre-close."""
...
def commit(arguments: argparse.Namespace) -> dict:
    ...
    committed_at = _utc()
    summary = {
        "schema": "campfire.phase6fy.preclose-memory-commit.v1",
    ...
    _append_jsonl(
        ...
        {
            "schema": "campfire.phase6fy.measurement-commit-marker.v1",
...
def main() -> int:
    ...
    status = {
        "schema": "campfire.phase6fy.preclose-committer-summary.v1",
