"""Run the frozen Phase 6HK proxy boundary under Phase 6HO identity."""
...
source = source_bytes.decode("utf-8").replace("phase6hk", "phase6ho").replace("Phase 6HK", "Phase 6HO")
