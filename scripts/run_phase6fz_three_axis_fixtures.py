"""Run the twenty frozen Phase 6FZ synthetic/short-lived fixtures."""
...
from phase6fz_three_axis_policy import classify_attempt, evaluate_population
...
def _valid(status: str = "normal", diagnostic: str = "not_required") -> dict:
    return {
        "operation": {
            ...
            "kit_import_contract_match": True,
        },
        "artifact": {
            "committed": True,
...
def main() -> int:
    ...
    report = {
        "schema": "campfire.phase6fz.three-axis-fixture-report.v1",
        "phase": "phase6fz",
