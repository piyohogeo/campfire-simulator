"""Pure Phase 6FY three-axis classification and replacement policy.
...
def _decision(classification: str, failures: list[str], lifecycle: dict, diagnostic: dict) -> dict:
    return {
        "schema": "campfire.phase6fy.three-axis-attempt-decision.v1",
...
def evaluate_population(attempts: list[dict], contract: dict) -> dict:
    ...
    return {
        "schema": "campfire.phase6fy.population-policy-decision.v1",
