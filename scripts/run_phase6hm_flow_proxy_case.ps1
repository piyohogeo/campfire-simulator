...
$arguments = @(
    ...
    "--enable", "omni.flowusd",
    "--/phase6hm/output=$output",
    "--/phase6hm/markers=$markers",
    "--/phase6hm/stageCloseTimeoutSeconds=$StageCloseTimeoutSeconds",
    "--/log/file=$kitLog",
...
$evidence = [ordered]@{
    schema = "campfire.phase6hm.flow-proxy-case-runner.v1"
    phase = "phase6hm"
