...
$policy=Get-Content -Raw -Encoding UTF8 -LiteralPath $contract|ConvertFrom-Json;$required=@($policy.runtime.required_markers);$missing=@($required|Where-Object{$markerNames -notcontains $_})
